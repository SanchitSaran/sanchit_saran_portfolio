...
List<Project> demo_projects = [
  Project(
    title: "My EE , British Telecommunications Group",
    description:
    "My EE makes it easy to look after your account and get more from EE.",
  ),
  Project(
  ...
  Project(
    title: "RentTry - A Ride Rent App",
    description:
    "RentTry is budget-friendly bike rental platform offering you bikes on rent for just Rs. 7/- hour. We provide scooters and bikes on rent in Jaipur facilities to commute a short or long distance. Rent a bike from RentTry on an hourly, daily or monthly basis.",
  ),
];
